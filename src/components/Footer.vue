<template>
  <div>
    <tabbar>
      <tabbar-item :link="{path:'/announcement'}"  selected>
      ...
      <tabbar-item :link="{path:'/'}" >
        ...
        <span slot="label">资金</span>
      </tabbar-item>
      <tabbar-item :link="{path:'/mysettings'}" @on-item-click="onclick1">
